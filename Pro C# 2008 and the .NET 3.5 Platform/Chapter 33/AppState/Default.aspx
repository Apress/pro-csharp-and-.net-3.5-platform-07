...
<body>
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Font-Size="X-Large" 
          Text="Fun with Application State" style="font-size: xx-large"></asp:Label><br />
        <br />
        <hr />
        <br />
        <asp:Button ID="btnShowCarOnSale" runat="server" 
          onclick="btnShowCarOnSale_Click1" Text="Get Car On Sale" />
